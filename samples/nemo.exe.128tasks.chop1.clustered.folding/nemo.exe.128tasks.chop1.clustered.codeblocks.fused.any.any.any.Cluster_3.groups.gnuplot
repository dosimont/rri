...
set border 1
set xlabel "Time (ms)";
set title "Instance groups for Appl * Task * Thread * - Region Cluster_3\n1038 Instances - No instance grouping"
...
set label "" at 128517131.0/1000000.0,0 point lt 1 ps 3 lc rgb "#FF0000";

plot \
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.groups.csv' using (strcol(1) eq 'u' && (strcol(2) eq 'Cluster_3' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 ti 'Group_0 (794/244)' w points ls 1,\
'nemo.exe.128tasks.chop1.clustered.codeblocks.fused.any.any.any.groups.csv' using ((strcol(1) eq 'e') && (strcol(2) eq 'Cluster_3' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 notitle w points lc rgbcolor "#808080" ;
